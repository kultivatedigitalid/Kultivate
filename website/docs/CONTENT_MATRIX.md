...
|---|---|---|---|---|---|---|---|
| home | /id/ | /en/ | APPROVED | APPROVED | Joshua | Four project-generated abstract WebP assets | 2026-08-10 localized display headings, elevated luminous hero, clarified system flow, horizon CTA |
| work-index | /id/work/ | /en/work/ | REVIEW | REVIEW | Joshua | 12 seeded showcase visuals | Three-up asymmetric gallery; final verified portfolio list remains pending |
...
| services | /id/services/ | /en/services/ | APPROVED | APPROVED | Joshua | Strategic content | Connected system hub |
...
| privacy | /id/privacy/ | /en/privacy/ | REVIEW | REVIEW | Legal owner | Policy text active | Matches static integration |
