...
export const siteConfig = {
  ...
  // STRATEGIC DECISION
  name: 'Kultivate',
  tagline: 'Connected Digital Growth',
  
  // PENDING - PLACEHOLDER - NOT PUBLIC PROOF
  domain: 'https://kultivate.id', // Target domain
  email: 'hello@kultivate.id', // Target public business email
  ...
  addressClassification: 'Office / Digital Hub',
  
  // PENDING - PLACEHOLDER - NOT PUBLIC PROOF (Form submission)
  formEndpoint: 'https://formspree.io/f/placeholder', // Will be updated when Formspree endpoint is approved
