...
out=root.parents[1]/'outputs/Kultivate_Learn_C01L01_Sample_2026-09-14'
report={}
...
for f in out.glob('*.docx'):
    ...
    assert 'QA_RENDER_STATUS' not in text
...
with zipfile.ZipFile(out/'C01L01_Teaching_Slides.pptx') as z:
